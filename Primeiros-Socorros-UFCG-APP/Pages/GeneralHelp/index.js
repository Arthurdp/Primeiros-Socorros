    ...
    <View style={styles.container}>
      <ScrollView >
        <View style={styles.titleBar}>
          <View style={styles.numberView}><Text style={styles.number}>1</Text></View>
          <Text style={styles.title}>Cheque o ambiente</Text></View>
        ...
        <View style={styles.titleBar}>
          <View style={styles.numberView}><Text style={styles.number}>2</Text></View>
          <Text style={styles.title}>Chame ajuda</Text></View>
        ...
        <View style={styles.titleBar}>
          <View style={styles.numberView}><Text style={styles.number}>3</Text></View>
          <Text style={styles.title}>Cuide da vítima</Text></View>
